...
namespace UI.Areas.Admin.Controllers
{
    public class CategoryController : BaseController
    {
        ...
        {
            List<CategoryDTO> model = bll.GetCategory();
            string[] Data = { "Category List", "Categorys", "Category", "CategoryList" };
            ViewData["Data"] = Data;
            return View(model);
        }
        public ActionResult AddCategory()
        {
            ...
            string[] Data = { "Add Category", "Categorys", "Category", "CategoryList" };
            ViewData["Data"] = Data;
            return View(dto);
        }
        [HttpPost]
        ...
        public ActionResult UpdateCategory(int ID)
        {
            ...
            string[] Data = { "Update Category", "Categorys", "Category", "CategoryList" };
            ViewData["Data"] = Data;
            return View(dto);
        }
        [HttpPost]
